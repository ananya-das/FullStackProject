          ...
          <div class = "right">
            <div class = "signup_form">
              <form action = "signup.php" method = "post">
                ...
                <input class = "fname" id="fname" type = "text" name = "user-fname" placeholder = "First Name">
                <label for = "lname">Last Name</label>
                <input class = "lname" id="lname" type = "text" name = "user-lname" placeholder = "Last Name">
                <label for = "password">Username<span> *</span></label>
                <input class = "username" id="username" type = "text" name="user-name" placeholder = "Username">
                <label for = "password">Password<span> *</span></label>
                <input class = "password" id="password" type = "password"  name="user-pass" placeholder = "Password">
                <label for = "email">Email Address<span> *</span></label>
                <input class = "email" id="email" type = "email" name="user-email" placeholder = "Email Address">
                <button class = "submit" type = "submit" name = "signup-btn" value="Signup" id="submit" onclick="alert('Sign in after you sign up')" >SUBMIT</button>
              </form>
            </div>
          </div>
        </div>
            ...
            <div class = "right">
              <div class = "signup_form">
                ...
                <form action = "login.php" method = "post">
                  ...
                  <input class = "fname" type = "text" name="user-name" placeholder = "Username">
                  <label for = "password">Password<span> </span></label>
                  <input class = "password" id="password" type = "password"  name="user-pass" placeholder = "Password">
                  <button class = "submit" type = "submit" name="login-btn" >SIGN IN</button>
                  <input type = "checkbox">Remember me<br>
                  <a class = "forgot" href = "recover_email.php">Forgot password?</a>
                  <br>
                </form>
              </div>
              <div class = "flex_social">
                <a href = "https://yisoostudiess.carrd.co/"><img src = "images/globe.svg"></a>
                <a href = "https://www.instagram.com/yisoostudiess/"><img src = "images/instagram.svg"></a>
                <a href = "https://yisoostudiess.tumblr.com/"><img src = "images/tumblr.svg"></a>
                <a href = "https://www.pinterest.com/yisoostudiess/"><img src = "images/pinterest.svg"></a>
              </div>
            </div>
          </div>
        </div>
